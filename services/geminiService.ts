...
const getAiClient = () => {
  // Supports standard process.env (Sandbox) and import.meta.env (Vite)
  // In local .env file, name your key VITE_API_KEY
  const apiKey = process.env.API_KEY || (import.meta as any).env?.VITE_API_KEY;
  
  if (!apiKey) {
    console.warn("API Key is missing. Please set VITE_API_KEY in your .env file.");
  }
